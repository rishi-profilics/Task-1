...
export default function Tab() {
  ...
  return (
    <div className='w-full flex gap-8 border-b border-zinc-400 p-6 mb-5 items-center'>
        <Link className='w-fit relative' to="/">
            <h3 className={` ${pathname == "/" ? "text-black font-semibold" : "text-zinc-600"} `}>Edit Profile</h3>
            {pathname == "/" && <div className="absolute w-full left-0.5 top-12 bg-zinc-800 h-px"/>} 
        </Link>
        <Link className='w-fit relative' to="/calender">
            ...
            {pathname == "/calender" && <div className="absolute w-full left-0.5 top-12 bg-zinc-800 h-px"/>} 
        </Link>
        <Link className='w-fit relative' to="/timeline">
            ...
            {pathname == "/timeline" && <div className="absolute w-full left-0.5 top-12 bg-zinc-800 h-px"/>} 
        </Link>
        {/* <Link className='w-fit relative' to="/">
